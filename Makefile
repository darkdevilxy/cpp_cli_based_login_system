...
all: cmake_check_build_system
	$(CMAKE_COMMAND) -E cmake_progress_start /run/media/darkdevilxy/Data_C/c++/untitled/CMakeFiles /run/media/darkdevilxy/Data_C/c++/untitled//CMakeFiles/progress.marks
	$(MAKE) $(MAKESILENT) -f CMakeFiles/Makefile2 all
	$(CMAKE_COMMAND) -E cmake_progress_start /run/media/darkdevilxy/Data_C/c++/untitled/CMakeFiles 0
.PHONY : all
